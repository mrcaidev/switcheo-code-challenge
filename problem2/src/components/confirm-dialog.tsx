...
export function ConfirmDialog({ disabled, onConfirm, children }: Props) {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This action cannot be undone, and the final rate may vary based on
